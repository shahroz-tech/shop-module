        ...
        <div class="hidden w-full md:flex md:items-center md:w-auto justify-end space-x-6" id="navbar-dropdown">
            <ul class="flex flex-col md:flex-row md:space-x-6 font-medium items-center p-4 md:p-0 mt-4 md:mt-0">
                ...
                @auth
                    ...
                    <li>
                        <a href="/cart"
                           class="relative flex items-center text-gray-700 hover:text-indigo-600 transition">
                            ...
                            @if(session('cart_count', 0) > 0)
                                <span
                                    class="absolute -top-1 -right-2 bg-red-600 text-white text-xs font-semibold rounded-full px-1.5 py-0.5">
                                    {{ session('cart_count') }}
                                </span>
                            @endif
                        </a>
                    ...
                    <li class="relative group">
                        <button
                            class="flex items-center text-gray-700 hover:text-indigo-600 px-3 py-1 rounded-sm focus:outline-none">
                            Hi, {{ auth()->user()->name }}
                            @if($role==='customer')
