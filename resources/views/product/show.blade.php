        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-1">
                        ...
                        <form action="/cart/add" method="POST" class="flex flex-col gap-4">
                            ...
                            @if($product->stock > 0)
                                ...
                                <div>
                                    ...
                                    <input required type="number" name="quantity" id="quantity" value="1" min="1" max="{{ $product->stock }}"
                                           class="mt-1 block w-24 border-gray-300 rounded-md shadow-sm focus:ring-yellow-400 focus:border-yellow-400 sm:text-sm">
                                    <p class="mt-1 text-xs text-gray-500">Available stock: {{ $product->stock }}</p>
                                </div>
               ...
               text-gray-900 font-medium rounded-lg shadow transition"
                            ...
                            @else
                                <!-- Out of Stock -->
                                <p class="mt-4 px-4 py-2 bg-red-100 text-red-700 font-medium rounded-lg text-center">
                                    🚫 Out of Stock
                                </p>
                            @endif
                        </form>
